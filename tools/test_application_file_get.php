...
<form name="input" action="/?class=application&mode=file&from=get" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'time'=>"",
    'time_stamp'=>time(),
    'flid'=>isset($_GET['flid'])?$_GET['flid']:"",
    'total'=>isset($_GET['total'])?$_GET['total']:2
);
$server_sign='';
