...
<form name="input" action="/?class=application&mode=file&from=upload" method="POST" enctype="multipart/form-data">
<?php
...
echo "<label for=\"file\">文件:</label><input type=\"file\" name=\"file\" id=\"file\"><br>";
