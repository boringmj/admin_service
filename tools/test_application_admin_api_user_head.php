...
<form name="input" action="/?class=admin_api&mode=user_head<?php echo "&encode_type={$_GET['encode_type']}&return={$_GET['return']}"?>" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'qq'=>isset($_GET['qq'])?$_GET['qq']:"3239957605",
);
$server_sign='';
