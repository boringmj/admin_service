...
<form name="input" action="/?class=application&mode=admin_application_user_ibrary&from=renew" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'span_id'=>isset($_GET['span_id'])?$_GET['span_id']:""
);
$server_sign='';
