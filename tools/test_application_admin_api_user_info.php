...
<form name="input" action="/?class=admin_api&mode=user_info<?php echo "&encode_type={$_GET['encode_type']}&return={$_GET['return']}"?>" method="POST" enctype="multipart/form-data">
<?php
