...
<form name="input" action="/?class=application&mode=admin_application&from=states" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'states'=>isset($_GET['states'])?$_GET['states']:"Y"
);
$server_sign='';
