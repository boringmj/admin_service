...
<form name="input" action="/?class=application&mode=message&from=send" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'title'=>base64_encode(isset($_GET['title'])?$_GET['title']:"消息标题"),
    'content'=>base64_encode(isset($_GET['content'])?$_GET['content']:"信息内容233333哈啊啊'<=&>!@#厉害了"),
    'ruid'=>isset($_GET['ruid'])?$_GET['ruid']:""
);
$server_sign='';
