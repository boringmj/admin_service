...
<form name="input" action="/?class=application&mode=tutorial_check&from=check" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'stateus'=>isset($_GET['stateus'])?$_GET['stateus']:"Y",
