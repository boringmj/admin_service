...
<form name="input" action="/?class=application&mode=tutorial_info&from=info" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'condition'=>isset($_GET['condition'])?$_GET['condition']:"approved",
