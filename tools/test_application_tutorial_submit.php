...
<form name="input" action="/?class=application&mode=tutorial&from=submit" method="POST" enctype="multipart/form-data">
<?php
...
$server_variable=array(
    ...
    'title'=>base64_encode(isset($_GET['title'])?$_GET['title']:"教程标题"),
    'content'=>base64_encode(isset($_GET['content'])?$_GET['content']:"教程内容233333哈啊啊'<=&>!@#厉害了")
);
$server_sign='';
